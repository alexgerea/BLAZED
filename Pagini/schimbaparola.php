...
<html lang="ro">
    <head>
        <title>BLAZED - Schimbare parolă</title>
    ...
    <header>
        ...
        <div class="formwrap">
            ...
            <form action="../Scripturi/Login/changepassword.php" method="post">
                ...
                <?php } ?>
                <h1 class="label">Parola veche:</h1>
                <div class="oldpass">
                    <input type="password" name="oldpasswordf" class="oldpasswordf" placeholder="Introduceți parola veche...">
                </div>

                <h1 class="label">Parola noua:</h1>
                <div class="newpass">
                    <input type="password" name="passwordf" class="passwordf" placeholder="Introduceți parola noua...">
                </div>

                <h1 class="label">Parola noua inca o data:</h1>
                <div class="newpassv">
                    <input type="password" name="passwordfv" class="passwordfv" placeholder="Introduceți parola noua...">
                </div>
