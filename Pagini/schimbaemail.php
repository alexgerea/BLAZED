...
<html lang="ro">
    <head>
        <title>BLAZED - Schimbare mail</title>
    ...
    <header>
        ...
        <div class="formwrap">
            <h1 class="titlecontact">Schimbare mail</h1>
            <h2 class="userinfo"><p>Sunteți logat ca <?php echo "$_SESSION[nume] $_SESSION[prenume]";?><br>
            Email: <?php echo "$_SESSION[email]" ?></p></h2>
            <form action="../Scripturi/Login/changeemail.php" method="post">
                <?php if(isset($_GET['errorf'])){ ?>
                    <p class="errorf"><?php echo $_GET['errorf'];?></p>
                <?php } ?>

                <h1 class="label">Emailul nou:</h1>
                <div class="newpass">
                    <input type="email" name="emailf" class="passwordf" placeholder="Introduceți emailul nou...">
                </div>

                <h1 class="label">Emailul nou inca o data:</h1>
                <div class="newpassv">
                    <input type="email" name="emailfv" class="passwordfv" placeholder="Introduceți emailul nou inca o data...">
                </div>
