...
<html lang="ro">
    ...
    <header>
                    ...
                    <div class="dropdown-menu cart">
                        <?php if(!isset($_SESSION['id'])) {?>
                            <div class="shopinfo">
                                ...
                                <button class="startexploring"><a href="contact.php?alert=Introduceți datele">Login</a></button>
                            </div>
                        <?php }else{?>
        ...
        <div class="formwrap">
            <h1 class="titlecontact">Contacteaza-ne</h1>
            <form action="../Scripturi/Contact/contactscript.php" method="post">
                <?php if(isset($_GET['errorf'])){ ?>
                    <p class="errorf"><?php echo $_GET['errorf'];?></p>
                <?php } ?>
                <h1 class="label">Email:</h1>
                <div class="email">
                    <input type="email" name="emailc" class="email input" placeholder="Introduceți e-mail...">
                </div>

                <h1 class="label">Selecteaza categoria mesajului:</h1>

                <div class="selectcategory">
                    <select name="categoriec">
                        <option value="Propunere">Propunere</option>
                        <option value="Raportare Bug">Raportare Bug</option>
                    </select>
                </div>

                <h1 class="label">Mesaj:</h1>
                <div class="message"><textarea name="mesajc" cols="30" rows="10" placeholder="Scrieți mesajul..."></textarea></div>

                <h1 class="label">Rating pentru BLAZED:</h1>
                <div class="stars">
                ...
                <input type="hidden" id="ratingc" name="ratingc" value="">
                <input type="submit" onclick="transportrating()" value="Trimite">
                <script>
                    function transportrating(){
                        document.getElementById("ratingc").value = setrating();
                    }
                </script>
            </form>
        </div>
        ...
        <script src="../Scripturi/rating.js"></script>
    </body>
</html>