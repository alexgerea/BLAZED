...
<html lang="ro">
    <head>
        <title>BLAZED - Administrare cont</title>
    ...
    <header>
        ...
        <div class="formwrap">
            <h1 class="titlecontact">Administrare cont</h1>
            <h2 class="userinfo"><p>Sunteți logat ca <?php echo "$_SESSION[nume] $_SESSION[prenume]";?><br>
            Email: <?php echo "$_SESSION[email]" ?></p></h2>
            <button class="startexploring"><a href="schimbaparola.php">Schimbare parola</a></button>
            <button class="startexploring"><a href="schimbaemail.php">Schimbare mail</a></button>
            <button class="startexploring"><a href="stergecont.php">Stergere cont</a></button>
        </div>
        <footer>
