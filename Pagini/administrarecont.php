...
<html lang="ro">
    ...
    <header>
        ...
        <div class="formwrap">
            ...
            <button class="startexploring"><a href="schimbaparola">Schimbare parola</a></button>
            <button class="startexploring"><a href="schimbaemail">Schimbare mail</a></button>
            <button class="startexploring"><a href="stergecont">Stergere cont</a></button>
        </div>
        <footer>
